...
from XMARTROBOT import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"XMARTROBOT/modules/{shortname}.py")
        name = "XMARTROBOT.modules.{}".format(shortname)
        ...
        mod.XMARTROBOT = XMARTROBOT
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["XMARTROBOT.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "XMARTROBOT/modules/*.py"
